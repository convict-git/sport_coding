  ...
  for (int i = 0; i < 10 && !found; ++i) {
    for (int j = 0; j < 10; ++j) {
      if (mat[i][j] == '.') {
        ...
        int l = 0, r = 0, x = i, y = j;
        x = i, y = j;
        while (x + 1 < 10 && y - 1 >= 0 && mat[x + 1][y - 1] == 'X') {
          ++x, --y;
        }
        r = x - i;
        x = i, y = j;
        while (x - 1 >= 0 && y + 1 < 10 && mat[x - 1][y + 1] == 'X') {
          --x, ++y;
        }
        l = y - j;
        if (l + r + 1 >= 5) {
        ...
        x = i, y = j;
        while (x + 1 < 10 && y + 1 < 10 && mat[x + 1][y + 1] == 'X') {
          ++x, ++y;
        }
        r = x - i;
        x = i, y = j;
        while (x - 1 >= 0 && y - 1 >= 0 && mat[x - 1][y - 1] == 'X') {
          --x, --y;
        }
        l = j - y;
        if (l + r + 1 >= 5) {
        ...
        // check up down
        x = i, y = j;
        while (x + 1 < 10 && mat[x + 1][y] == 'X') {
          ++x;
        }
        r = x - i;
        x = i, y = j;
        while (x - 1 >= 0 && mat[x - 1][y] == 'X') {
          --x;
        }
        l = i - x;
        if (l + r + 1 >= 5) {
        ...
        //
        x = i, y = j;
        while (y + 1 < 10 && mat[x][y + 1] == 'X') {
          ++y;
        }
        r = y - j;
        x = i, y = j;
        while (y - 1 >= 0 && mat[x][y - 1] == 'X') {
          --y;
        }
        l = j - y;
        if (l + r + 1 >= 5) {
