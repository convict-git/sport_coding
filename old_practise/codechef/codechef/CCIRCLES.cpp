...
inline bool out (cc c1, cc c2) { return floor (sqrtl(dcsq(c1, c2))) >= c1.r + c2.r; }
inline bool in (cc c1, cc c2) { return ceil (sqrtl(dcsq(c1, c2))) + c1.r <= c2.r; } //TODO why? ceil nd not floor
